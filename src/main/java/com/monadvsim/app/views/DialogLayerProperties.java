...
public class DialogLayerProperties extends JDialog {
    ...
    private void initUI() {
        ...
        gbc.gridx = 0;
        gbc.gridy++;
        mainPanel.add(new JLabel("Visible:"), gbc);
        gbc.gridx = 1;
        visibleCheck = new JCheckBox("", layer.isVisible());
        mainPanel.add(visibleCheck, gbc);

        gbc.gridx = 0;
        gbc.gridy++;
        mainPanel.add(new JLabel("CRS:"), gbc);
        gbc.gridx = 1;
        crsBox = new JComboBox<>(new String[]{"EPSG:4326", "EPSG:3857"});
        crsBox.setSelectedItem(layer.getCrsCode());
        mainPanel.add(crsBox, gbc);
        ...
        if (layer instanceof AgentLayer al) {
            gbc.gridx = 0;
            gbc.gridy++;
            mainPanel.add(new JLabel("Agent Color:"), gbc);
            gbc.gridx = 1;
            ...
            gbc.gridx = 0;
            gbc.gridy++;
            mainPanel.add(new JLabel("Population:"), gbc);
            gbc.gridx = 1;
            ...
            gbc.gridx = 0;
            gbc.gridy++;
            mainPanel.add(new JLabel("Base Speed:"), gbc);
            gbc.gridx = 1;
            ...
            gbc.gridx = 0;
            gbc.gridy++;
            mainPanel.add(new JLabel("Sim Options:"), gbc);
            gbc.gridx = 1;
    ...
    public String getSelectedCrs() {
        return (String) crsBox.getSelectedItem();
    }
