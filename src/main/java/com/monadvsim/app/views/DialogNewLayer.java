...
public class DialogNewLayer extends JDialog {
    ...
    public String getLayerType() {
        return (String) this.layerTypeField.getSelectedItem();
    }

    public String getLayerName() {
        return this.layerNameField.getText().trim();
    }
    ...
    public boolean isWrapAround() {
        return wrapAroundCheck.isSelected();
    }
    ...
    public JTextField getLayerNameField() {
